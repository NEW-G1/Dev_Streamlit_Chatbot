...
os.environ["SQL_VECTARA_CUSTOMER_ID"] = st.secrets.SQL_VECTARA_CUSTOMER_ID
os.environ["SQL_VECTARA_CORPUS_ID"] = st.secrets.SQL_VECTARA_CORPUS_ID
os.environ["SQL_VECTARA_API_KEY"] = st.secrets.SQL_VECTARA_API_KEY
...
#Setup Function
def sql_vectara_retriever():
  vectara = Vectara(
      vectara_customer_id = os.getenv("SQL_VECTARA_CUSTOMER_ID")
    , vectara_corpus_id   = os.getenv("SQL_VECTARA_CORPUS_ID")
    , vectara_api_key     = os.getenv("SQL_VECTARA_API_KEY")
  )
  ...
  """
  retriever=vectara.as_retriever(search_type="similarity")
...
def sql_agent_retriever(query: str) -> str:
  ...
  agent = create_sql_agent(
    ...
    extra_tools=[sql_vectara_retriever()],
